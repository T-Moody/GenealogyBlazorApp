        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorTheme = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountySeat = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    HistoricalNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    HeaderImagePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDurationMinutes = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceCounties", x => new { x.ResourceId, x.CountyId });
                    table.ForeignKey(
                        name: "FK_ResourceCounties_Counties_CountyId",
                        column: x => x.CountyId,
                        principalTable: "Counties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceCounties_Resources_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceCounties_CountyId",
                table: "ResourceCounties",
                column: "CountyId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceCounties_ResourceId",
                table: "ResourceCounties",
                column: "ResourceId");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_AccessLevel",
                table: "Resources",
                column: "AccessLevel");
